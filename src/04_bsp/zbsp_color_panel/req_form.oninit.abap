*&---------------------------------------------------------------------*
*& req_form.htm - OnInitialization
*&---------------------------------------------------------------------*
*& DIPASTE ke tab Event Handler -> OnInitialization. Tab OnRequest
*& dibiarkan kosong.
*&
*& Handler ini SENGAJA hanya mengurus identitas dan penjagaan. Ia tidak
*& menyentuh gv_so_number maupun gt_items sama sekali.
*&
*& Alasannya: urutan event BSP adalah
*&     OnRequest -> OnInputProcessing -> OnInitialization -> Layout
*& Hasil pencarian SO diisi di OnInputProcessing, yang berjalan LEBIH
*& DULU. Kalau handler ini ikut mengisi atau membersihkan gt_items,
*& hasil pencarian yang barusan didapat akan terhapus sebelum sempat
*& ditampilkan.
*&---------------------------------------------------------------------*
...
*&--- Penjagaan: yang boleh membuat request -----------------------------
* Membuat request adalah pekerjaan Sales. Admin diberi kapabilitas yang
* sama supaya bisa membuatkan atas nama Sales bila diperlukan.
